          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="text-ellipsis">
                ...
                ?>
                    <a href="{{ URL::to('/unactive-brand-product/'.$brand_pro->brand_id) }}"><span class="fa-thumbs-styling fa fa-thumbs-down"></span></a>
                <?php
                    }else {
                ?>
                    <a href="{{ URL::to('/active-brand-product/'.$brand_pro->brand_id) }}"><span class="fa-thumbs-styling fa fa-thumbs-up"></span></a>
                <?php
                    }
                ?>
            </span></td>
