    ...
    <div class="panel panel-default">
        ...
        ?>
            <table class="table table-striped b-t b-light">
                ...
                ?>
                                <a href="{{ route('unactive_brand', ['id' =>$brand_pro->id]) }}"> <span class="fa-thumbs-styling fa fa-thumbs-down"></span></a>
                                <?php
                    }else {
                ?>
                                <a href="{{ route('active_brand', ['id' =>$brand_pro->id]) }}"><span
